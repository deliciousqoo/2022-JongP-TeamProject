...
//				}
//				json.add(rs.getString(1), temp);
//			}
			if(rs.next()) {
				json.addProperty("SSN", rs.getString(1));
				json.addProperty("NAME", rs.getString(2));
				json.addProperty("RANK", rs.getString(3));
				if( rs.getString(5) == null) {					
					json.addProperty("ATTEND",false);
				}else {
					json.addProperty("ATTEND",true);
				}
			}
