...
//
//class RecyclerAdapter_Fragment1(val datas: ArrayList<Agenda>): RecyclerView.Adapter<RecyclerView.ViewHolder>() {
//
...
//        if (holder is RecyclerAdapter_Fragment1.Frag2ViewHolder) {
//            val binding = holder.binding
//            binding.progNo.text = "행사 " + datas[position].no
